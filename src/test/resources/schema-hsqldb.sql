...
alter table quote_author add foreign key (username) references users (email)
  on delete cascade;

create unique index idx_quote_username_authors on quote_author (username, author);
...
create unique index idx_quote_username_tags on quote_tag (username, tag);
